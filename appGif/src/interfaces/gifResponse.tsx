...
export class Convert {
    public static toGIFTrendingResponse(json: string): GIFTrendingResponse {
        return cast(JSON.parse(json), r("GIFTrendingResponse"));
    }

    public static gIFTrendingResponseToJson(value: GIFTrendingResponse): string {
        return JSON.stringify(uncast(value, r("GIFTrendingResponse")), null, 2);
    }
}
